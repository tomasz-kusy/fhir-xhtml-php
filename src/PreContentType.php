...
/**
 * Class representing PreContentType
 *
 * pre uses "Inline" excluding big, small, sup or sup
 * XSD Type: pre.content
 */
class PreContentType
{
     ...
     */
    public function addToA(\TKusy\FhirXhtml\A $a)
    {
        $this->a[] = $a;
        return $this;
    }
